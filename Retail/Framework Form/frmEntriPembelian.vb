...
Public Class FrmEntriPembelian
    ...
    Private Sub FrmEntriPembelian_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub frmSimpleEntri_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            dlg.Show()
            Windows.Forms.Cursor.Current = Cursors.WaitCursor
            If FormName = "EntriPembelian" Then
    ...
    End Sub
    Sub Baru()
        Dim FormEntriName As String
        If TableNameD = "MBeliD" Then
            FormEntriName = "EntriPembelianD"
        Else
            FormEntriName = "EntriReturPembelianD"
        End If
        ...
        If x.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
            EksekusiSQL("Update MBarangD set IDBarang=" & NoID & " where MBarangD.NoID=" & x.NoID)
            RefreshDetil()
    ...
    Sub Edit()
        ...
        Catch ex As Exception
            XtraMessageBox.Show("Untuk mengedit pilih item yang akan diedit terlebih dahulu lalu tekan tombol edit" & vbCrLf & ex.Message, NamaAplikasi, MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
    ...
    Sub RefreshDetil()
        ...
        oda2 = New SqlDataAdapter(ocmd2)
        If TableNameD = "MBeliD" Then
            ocmd2.CommandText = "select " & TableNameD & ".*,MBarang.Kode as KodeStock,MBarang.Nama as NamaStock," & _
"MSatuan.Kode as Satuan,Mgudang.Kode as KodeGudang " & _
"From (" & TableNameD & " Inner Join " & "MBeli" & " On " & TableNameD & ".IDBeli=MBeli.NoID) " & _
"LEFT JOIN MBarang ON " & TableNameD & ".IDBarang=MBarang.NoID " & _
"LEFT JOIN MSatuan ON " & TableNameD & ".IDSatuan=MSatuan.NoID " & _
"LEFT JOIN MGudang ON " & TableNameD & ".IDGudang=MGudang.NoID " & _
" where MBeliD.IDBeli=" & NoID
        Else
            ocmd2.CommandText = "select " & TableNameD & ".*,MBarang.Kode as KodeStock,MBarang.Nama as NamaStock," & _
"MSatuan.Kode as Satuan,Mgudang.Kode as KodeGudang " & _
"From (" & TableNameD & " Inner Join " & "MReturBeli" & " On " & TableNameD & ".IDBeli=" & "MReturBeli" & ".NoID) " & _
"LEFT JOIN MBarang ON " & TableNameD & ".IDBarang=MBarang.NoID " & _
"LEFT JOIN MSatuan ON " & TableNameD & ".IDSatuan=MSatuan.NoID " & _
"LEFT JOIN MGudang ON " & TableNameD & ".IDGudang=MGudang.NoID " & _
" where " & TableNameD & ".IDBeli=" & NoID
        End If
        ...
        End If
        oda2.Fill(ds, "MBeliD")
        GC1.DataSource = ds.Tables("MBeliD")
        ...
        End If
        If System.IO.File.Exists(FolderLayouts & FormName & "Grid Pembayaran.xml") Then
            GridView1.RestoreLayoutFromXml(FolderLayouts & FormName & "Grid Pembayaran.xml")
        End If
    End Sub
    Sub RefreshPembayaran()
    ...
    Private Sub BarButtonItem4_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem4.ItemClick
        ...
        Try
            If XtraMessageBox.Show("Simpan Layout?", NamaAplikasi, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes AndAlso xOtorisasi.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
                ...
                GridView1.SaveLayoutToXml(FolderLayouts & FormName & "Grid Pembayaran.xml")
    ...
    Private Sub FrmEntriPembelian_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        If isNew Then
            BS.AddNew()
            IsiDefault()
        Else
