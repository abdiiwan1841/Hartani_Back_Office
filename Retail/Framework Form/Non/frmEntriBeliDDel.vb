...
Public Class frmEntriBeliDDel
    ...
    Private Function Simpan() As Boolean
        Try
            If IsNew Then
                SQL = "INSERT INTO MBeliD (NoID,IDBeli,IDBarangD,IDPOD,IDLPBD,NoUrut,Tgl,Jam,IDBarang,IDSatuan,Qty,QtyPcs,Harga,HargaPcs,CTN,DiscPersen1,DiscPersen2,DiscPersen3,Disc1,Disc2,Disc3,Jumlah,Catatan,IDGudang,Konversi,PPN,HargaNetto) VALUES ("
                ...
                SQL &= FixKoma((Bulatkan((txtHarga.EditValue * (1 - (txtDiscPersen1.EditValue / 100)) * (1 - (txtDiscPersen2.EditValue / 100)) * (1 - (txtDiscPersen3.EditValue / 100))), 0) - txtDiscRp1.EditValue - txtDiscRp2.EditValue - txtDiscRp3.EditValue))
                SQL &= ")"
            Else
                ...
                SQL &= " PPN=" & NullToLong(txtPPN.EditValue) & ","
                SQL &= " HargaNetto=" & FixKoma((Bulatkan((txtHarga.EditValue * (1 - (txtDiscPersen1.EditValue / 100)) * (1 - (txtDiscPersen2.EditValue / 100)) * (1 - (txtDiscPersen3.EditValue / 100))), 0) - txtDiscRp1.EditValue - txtDiscRp2.EditValue - txtDiscRp3.EditValue)) & ","
    ...
    Private Function IsValidasi() As Boolean
        ...
        If txtHarga.EditValue <= 0 Then
            If txtHarga.EditValue = 0 AndAlso XtraMessageBox.Show("Harga masih 0, lanjutkan penyimpanan?", NamaAplikasi, MessageBoxButtons.YesNo, MessageBoxIcon.Information, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then
                txtHarga.Focus()
                Return False
                Exit Function
    ...
    Private Sub HitungJumlah()
        ...
        Try
            ...
            SQL = "SELECT MBarangD.Konversi, MBarang.Ctn_Pcs,MBarang.PPN FROM MBarangD LEFT JOIN MBarang ON MBarang.NoID=MBarangD.IDBarang LEFT JOIN MSatuan ON MSatuan.NoID=MBarangD.IDSatuan WHERE MBarangD.IDBarang=" & NullToLong(txtBarang.EditValue) & " AND MSatuan.NoID=" & NullToLong(txtSatuan.EditValue)
