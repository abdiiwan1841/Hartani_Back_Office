...
Public Class frmHasilPostingAccounting
    ...
    Public Periode As Date = TanggalSystem
    ...
    Private Sub ctrlDaftar_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            dlg.TopMost = False
            dlg.Show()
            Me.Text = "Jurnal Rekap " & FormName & " Per Periode " & Periode.ToString("MMMM yyyy")
            RefreshData()
            RestoreLayout()
    ...
    Private Sub RestoreLayout()
        ...
        If System.IO.File.Exists(FolderLayouts & Me.Name & FormName & ".xml") Then
            GV1.RestoreLayoutFromXml(FolderLayouts & Me.Name & FormName & ".xml")
        End If

        Me.Width = Ini.BacaIniPath(FolderLayouts & Me.Name & FormName & ".ini", "Form", "Width", Me.Width)
        Me.Height = Ini.BacaIniPath(FolderLayouts & Me.Name & FormName & ".ini", "Form", "Height", Me.Height)
    ...
    Sub RefreshData()
        ...
        Try
            ...
            Windows.Forms.Cursor.Current = Cursors.WaitCursor
            If SQL = "" Then
                XtraMessageBox.Show("Query tidak tersedia.", NamaAplikasi, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Exit Try
            End If
    ...
    Private Sub mnSaveLayouts_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles mnSaveLayouts.ItemClick
        ...
        Try
            ...
            If XtraMessageBox.Show("Simpan Layout?", NamaAplikasi, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes AndAlso xOtorisasi.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
                GV1.SaveLayoutToXml(FolderLayouts & Me.Name & FormName & ".xml")

                Ini.TulisIniPath(FolderLayouts & Me.Name & FormName & ".ini", "Form", "Width", Me.Width)
                Ini.TulisIniPath(FolderLayouts & Me.Name & FormName & ".ini", "Form", "Height", Me.Height)
                Me.Left = (Screen.PrimaryScreen.WorkingArea.Width - Me.Width) \ 2
                Me.Top = (Screen.PrimaryScreen.WorkingArea.Height - Me.Height) \ 2
            End If
        Catch ex As Exception
