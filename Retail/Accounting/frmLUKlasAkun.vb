...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents cIsNeraca As DevExpress.XtraGrid.Columns.GridColumn
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cIsNeraca = New DevExpress.XtraGrid.Columns.GridColumn
        ...
        Me.Label2.Text = "DAFTAR KLAS AKUN"
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colNoID, Me.colKode, Me.colNama, Me.cAlias, Me.cIsNeraca, Me.cIsDebet})
        ...
        Me.cAlias.VisibleIndex = 2
        '
        'cIsNeraca
        '
        Me.cIsNeraca.Caption = "IsNeraca"
        Me.cIsNeraca.ColumnEdit = Me.RepositoryItemCheckEdit1
        Me.cIsNeraca.FieldName = "IsNeraca"
        Me.cIsNeraca.Name = "cIsNeraca"
        '
        ...
        'cIsDebet
        '
        Me.cIsDebet.Caption = "IsDebet"
        Me.cIsDebet.ColumnEdit = Me.RepositoryItemCheckEdit1
        Me.cIsDebet.FieldName = "IsDebet"
        Me.cIsDebet.Name = "cIsDebet"
        Me.cIsDebet.Visible = True
        Me.cIsDebet.VisibleIndex = 3
        '
        ...
        Me.Name = "frmLUKlasAkun"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Daftar Klas Akun"
...
#End Region
    ...
    Public Sub TampilData()
        ...
        strsql = "SELECT  * FROM MKlasAkun ORDER BY MKlasAkun.Kode"
        Try
    ...
    Private Sub cmdHapus_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdHapus.Click
        ...
        Dim row As System.Data.DataRow = view.GetDataRow(GridView1.FocusedRowHandle)
        Dim NOid As Long = row("ID")
        If FxMessage("Yakin Mau Hapus data ini?", ".:: HAPUS DATA KLAS AKUN ::.", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            EksekusiSQL("DELETE FROM MKlasAkun WHERE ID=" & NOid)
            TampilData()
        End If
    End Sub
End Class
