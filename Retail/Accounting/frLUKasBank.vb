...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frLUKasBank))
        ...
        Me.PanelControl2.Size = New System.Drawing.Size(96, 506)
        ...
        Me.PanelControl3.Location = New System.Drawing.Point(96, 490)
        ...
        Me.PanelControl4.Size = New System.Drawing.Size(597, 452)
        ...
        Me.GridControl1.Size = New System.Drawing.Size(593, 448)
        ...
        Me.ClientSize = New System.Drawing.Size(693, 544)
...
#End Region
    ...
    Public Sub TampilData()
        ...
        Finally
            oConn.Close()
        End Try
        GridControl1.DataSource = oDS.Tables("MBank")
    ...
    Private Sub SimpleButton5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If XtraMessageBox.Show(Me, "Yakin Mau Hapus data ini?", ".:: HAPUS DATA KAS/BANK ::.", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            EksekusiSQL("Update MBank set IsActive=0 where NoID=" & NoID)
            TampilData()
        End If
    End Sub
    ...
    Private Sub frLUKasBank_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        GridView1.SaveLayoutToXml(Application.StartupPath & "\System\Layouts\DaftarBankNF.xml")

    End Sub

    Private Sub frDaftarAlamat_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        TampilData()
        If System.IO.File.Exists(Application.StartupPath & "\System\Layouts\DaftarBankNF.xml") Then
            GridView1.RestoreLayoutFromXml(Application.StartupPath & "\System\Layouts\DaftarBankNF.xml")
        End If
    End Sub
