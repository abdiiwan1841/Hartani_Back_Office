...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents cmdPrintNeracaT As DevExpress.XtraEditors.SimpleButton
    Friend WithEvents SimpleButton4 As DevExpress.XtraEditors.SimpleButton
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frLaporanNeraca))
        ...
        Me.cmdPrintNeracaT = New DevExpress.XtraEditors.SimpleButton
        ...
        Me.PanelControl1.Size = New System.Drawing.Size(1011, 46)
        ...
        Me.SimpleButton8.Location = New System.Drawing.Point(310, 5)
        ...
        Me.TglSampai.Location = New System.Drawing.Point(339, 6)
        ...
        Me.Label14.Location = New System.Drawing.Point(106, 14)
        ...
        Me.TglDari.Location = New System.Drawing.Point(163, 12)
        ...
        Me.PanelControl2.Size = New System.Drawing.Size(1011, 387)
        ...
        Me.GridControl1.Location = New System.Drawing.Point(118, 2)
        Me.GridControl1.MainView = Me.GridView1
        Me.GridControl1.Name = "GridControl1"
        Me.GridControl1.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.RepositoryItemCheckEdit1})
        Me.GridControl1.Size = New System.Drawing.Size(891, 383)
        ...
        Me.PanelControl3.Controls.Add(Me.cmdPrintNeracaT)
        ...
        Me.PanelControl3.Size = New System.Drawing.Size(116, 383)
        Me.PanelControl3.TabIndex = 1
        '
        'SimpleButton4
        '
        Me.SimpleButton4.Cursor = System.Windows.Forms.Cursors.Hand
        Me.SimpleButton4.ImageIndex = 12
        Me.SimpleButton4.ImageList = Me.ImageList1
        Me.SimpleButton4.Location = New System.Drawing.Point(3, 163)
        Me.SimpleButton4.Name = "SimpleButton4"
        Me.SimpleButton4.Size = New System.Drawing.Size(110, 34)
        Me.SimpleButton4.TabIndex = 9
        Me.SimpleButton4.Text = "&Print Neraca"
        '
        'SimpleButton3
        '
        ...
        Me.SimpleButton3.Size = New System.Drawing.Size(110, 34)
        ...
        Me.SimpleButton7.Location = New System.Drawing.Point(3, 345)
        Me.SimpleButton7.Name = "SimpleButton7"
        Me.SimpleButton7.Size = New System.Drawing.Size(110, 34)
        ...
        Me.SimpleButton6.Size = New System.Drawing.Size(110, 34)
        ...
        Me.SimpleButton2.Size = New System.Drawing.Size(110, 34)
        ...
        Me.SimpleButton1.Size = New System.Drawing.Size(110, 34)
        Me.SimpleButton1.TabIndex = 1
        Me.SimpleButton1.Text = "&Preview"
        '
        'cmdPrintNeracaT
        '
        Me.cmdPrintNeracaT.Cursor = System.Windows.Forms.Cursors.Hand
        Me.cmdPrintNeracaT.ImageIndex = 14
        Me.cmdPrintNeracaT.ImageList = Me.ImageList1
        Me.cmdPrintNeracaT.Location = New System.Drawing.Point(3, 203)
        Me.cmdPrintNeracaT.Name = "cmdPrintNeracaT"
        Me.cmdPrintNeracaT.Size = New System.Drawing.Size(110, 34)
        Me.cmdPrintNeracaT.TabIndex = 10
        Me.cmdPrintNeracaT.Text = "Print Neraca T"
        '
        'frLaporanNeraca
        '
...
#End Region
    ...
    Sub RefreshData()
        ...
        If TglDari.Enabled Then
            ...
            Else
                strsql = strsql & " and "
            End If
            strsql = strsql & "MJurnal.Tanggal>='" & TglDari.DateTime.ToString("yyyy/MM/01") & "' " & _
            " AND MJurnal.Tanggal<'" & CDate(TglDari.DateTime.ToString("yyyy/MM/01")).AddMonths(1).ToString("yyyy/MM/dd") & "' "
            IsPerluwhere = False
        End If
        Try
    ...
    Private Sub SimpleButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton4.Click
        CetakFaktur(action_.Preview, "Neraca")
    End Sub
    Private Sub CetakFaktur(ByVal action As action_, ByVal NamaReport As String)
        ...
        Try
            ...
            If System.IO.File.Exists(namafile) Then
                ...
                End If
                ViewReport(Me.ParentForm, action, namafile, "Print Neraca Periode " & TglDari.DateTime.ToString("MMM yyyy"), , , "Bulan=" & TglDari.DateTime.Month & "&" & "Tahun=" & TglDari.DateTime.Year & "")
            Else
    ...
    Private Sub ProsesTutupBukuBulanan()
        ...
        str = "UPDATE MJurnalD SET IDDepartemen=1, IDMataUang=1, Kurs=1 FROM MJurnal WHERE IsNull(Kurs,0)<=0 OR IsNull(IDMataUang,0)<=0 OR IsNull(IDDepartemen,0)<=0"
        EksekusiSQL(str)
        ...
        ''Model Lama '24062013
        'str = "SELECT MKlasAkun.IsDebet,MJurnalD.IDDepartemen, MJurnalD.IDAkun, MJurnalD.IDMataUang, MMataUang.Kode AS KURS, MMataUang.KursTukar, " & _
        '      " (2 * MKlasAkun.IsDebet - 1) " & _
        ...
        'Model Debet Kredit Bukan debet-kredit (Hartani 24062013)
        str = "SELECT MKlasAkun.IsDebet,MJurnalD.IDDepartemen, MJurnalD.IDAkun, MJurnalD.IDMataUang, MMataUang.Kode AS KURS, MMataUang.KursTukar, " & vbCrLf & _
              " SUM(MJurnalD.Debet) AS SaldoRupiahDebet, " & vbCrLf & _
              " SUM(MJurnalD.Kredit) AS SaldoRupiahKredit, " & vbCrLf & _
              " SUM(MJurnalD.DebetA) AS SaldoValasDebet, " & vbCrLf & _
              " SUM(MJurnalD.KreditA) AS SaldoValasKredit, " & vbCrLf & _
              " MKlasAkun.IsNeraca*( SUM(MJurnalD.DebetA - MJurnalD.KreditA) * MMataUang.KursTukar - " & _
              " SUM(MJurnalD.Debet - MJurnalD.Kredit)) AS UntungKurs, MDepartemen.Kode AS KodeDepartemen, Makun.Kode As KodeAkun, Makun.Nama As NamaAkun " & _
              " FROM MKlasAkun INNER JOIN " & _
              " MSubKlasAkun INNER JOIN " & _
              ...
              " MDepartemen ON MJurnalD.IDDepartemen = MDepartemen.NoID " & _
              " WHERE  Month(Mjurnal.Tanggal)=" & tdbdate1.Month & " And Year(Mjurnal.Tanggal)=" & tdbdate1.Year & _
              " GROUP BY MAkun.ID, MKlasAkun.IsNeraca,MJurnalD.IDAkun, MJurnalD.IDMataUang, MMataUang.Kode, MMataUang.KursTukar, MKlasAkun.IsDebet, MJurnalD.IDDepartemen, " & _
              " MDepartemen.Kode , MAkun.Kode, MAkun.Nama " & _
              " ORDER BY MDepartemen.Kode,MAkun.Kode "
        ...
        Else
            For i = 0 To dsdata.Tables("Data").Rows.Count - 1
                SaldoAkhir = Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoRupiahDebet")), 2) - Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoRupiahKredit")), 2)
                SaldoAkhirA = Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldovalasDebet")), 2) - Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldovalasKredit")), 2)
                If SaldoAkhir >= 0 Then
                    str = "INSERT INTO MJurnalD (  IDJurnal, IDDepartemen, IDAkun, " & _
                      ...
                      FixKoma(SaldoAkhir) & "," & _
                      FixKoma(SaldoAkhirA) & "," & _
                ...
                Else
                    str = "INSERT INTO MJurnalD (  IDJurnal, IDDepartemen, IDAkun, " & _
                      ...
                      FixKoma(NullToDbl(dsdata.Tables("Data").Rows(i).Item("KursTukar"))) & "," & _
                      NullToLong(dsdata.Tables("Data").Rows(i).Item("IdMataUang")) & "," & _
                      FixKoma(-1 * SaldoAkhir) & "," & _
                      FixKoma(-1 * SaldoAkhirA) & "," & _
                      "0)"
                    EksekusiSQL(str)
                End If
                ...
                NullToLong(dsdata.Tables("Data").Rows(i).Item("IdAkun")) & "," & _
                FixKoma(IIf(NullToBool(dsdata.Tables("Data").Rows(i).Item("Isdebet")), 1, -1) * (Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoRupiahDebet")), 2) - Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoRupiahKredit")), 2))) & "," & _
                FixKoma(IIf(NullToBool(dsdata.Tables("Data").Rows(i).Item("Isdebet")), 1, -1) * (Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoValasDebet")), 2) - Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoValasKredit")), 2))) & "," & _
                FixKoma(NullToDbl(dsdata.Tables("Data").Rows(i).Item("KursTukar"))) & "," & _
                NullToLong(dsdata.Tables("Data").Rows(i).Item("IdMataUang")) & "," & _
            ...
            '              NullToLong(dsdata.Tables("Data").Rows(i).Item("IDDepartemen")) & "," & _
            '              NullToLong(dsdata.Tables("Data").Rows(i).Item("IdAkun")) & "," & _
            '              FixKoma(Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoRupiahDebet")), 2)) & "," & _
            '              FixKoma(Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldovalasDebet")), 2)) & "," & _
            '              FixKoma(NullToDbl(dsdata.Tables("Data").Rows(i).Item("KursTukar"))) & "," & _
            '              NullToLong(dsdata.Tables("Data").Rows(i).Item("IdMataUang")) & "," & _
            '              FixKoma(Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoRupiahKredit")), 2)) & "," & _
            '              FixKoma(Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldovalasKredit")), 2)) & "," & _
            '              "0)"
            '        EksekusiSQL(str)
            '        'MNeraca()
            '        str = "INSERT INTO MNeraca ( IDDepartemen, IDAkun, " & _
            ...
            '        "Values(" & NullToLong(dsdata.Tables("Data").Rows(i).Item("IDDepartemen")) & "," & _
            '        NullToLong(dsdata.Tables("Data").Rows(i).Item("IdAkun")) & "," & _
            '        FixKoma(Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoRupiahDebet")), 2) - Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoRupiahKredit")), 2)) & "," & _
            '        FixKoma(Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoValasDebet")), 2) - Bulatkan(NullToDbl(dsdata.Tables("Data").Rows(i).Item("SaldoValasKredit")), 2)) & "," & _
            '        FixKoma(NullToDbl(dsdata.Tables("Data").Rows(i).Item("KursTukar"))) & "," & _
            '        NullToLong(dsdata.Tables("Data").Rows(i).Item("IdMataUang")) & "," & _
            '        "'" & Format(tdbdate1, "yyyy/MM/dd") & "')"
            '        EksekusiSQL(str)
        ...
        Else
            For j = 0 To dsdata.Tables("Laba").Rows.Count - 1
                str = "INSERT INTO MNeraca ( IDDepartemen, IDAkun, " & _
                            ...
                            FixKoma(Bulatkan(NullToDbl(dsdata.Tables("Laba").Rows(j).Item("Jumlah")), 2)) & "," & _
                            FixKoma(Bulatkan(NullToLong(dsdata.Tables("Laba").Rows(j).Item("Jumlah")), 2)) & "," & _
                            1 & "," & _
                            defIDMataUang & "," & _
                            "'" & Format(tdbdate1, "yyyy-MM-dd") & "')"
                EksekusiSQL(str)
    ...
    Private Sub cmdPrintNeracaT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrintNeracaT.Click
        CetakFaktur(action_.Preview, "NeracaT")
    End Sub
End Class
