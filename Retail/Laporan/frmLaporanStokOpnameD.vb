...
Public Class frmLaporanStockOpnameD
    Public FormName As String = "LaporanStockOpnameD"
    ...
    Sub RefreshData()
        ...
        Try
            ...
            strsql = "Select MSupplier.Nama as Supplier,MKategori.Nama as Kategori, MBarang.Kode,Mbarang.Nama,MBarangD.Barcode,MStockOpnameD.QtyFisik,MStockOpnameD.HargaPokok, MStockOpnameD.HargaJual,MStockOpnameD.QtyFisik*MStockOpnameD.HargaPokok as NilaiFisik,MStockOpnameD.QtyFisik*MStockOpnameD.HargaJual as NilaiJualFisik  " & _
            "from (MStockOpnamed inner join MStockOpname on MStockOpnameD.IDHeader=MStockOpname.NoID) " & _
            "left join MBarangD on MStockOpnamed.IDBarangD=MBarangD.NoID " & _
             "left join MBarang on MBarangD.IDBarang=MBarang.NoID " & _
              "left join MKategori on MBarang.IDKategori=MKategori.NoID " & _
             "left join MAlamat MSupplier on MBarang.IDSupplier1=MSupplier.NoID " & _
            "where MStockOpname.Tanggal>='" & Format(TglDari.DateTime, "yyyy-MM-dd") & "' and MStockOpname.tanggal<'" & _
            Format(TglSampai.DateTime.AddDays(1), "yyyy-MM-dd") & "'"
            ...
            If txtSupplier.Enabled Then
                strsql = strsql & " and MBarang.IDSupplier1=" & NullToLong(txtSupplier.EditValue)
            End If
            If RadioButton1.Checked Then
                strsql = strsql & " and MStockOpnameD.QtyFisik<=0"
    ...
    Private Sub ckAllStock_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        RefreshData()
    End Sub
