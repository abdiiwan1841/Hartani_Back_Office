...
Public Class frmReminder
    ...
    Private Sub frmHasilPosting_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If XtraMessageBox.Show("Ingin menampilkannya ulang dalam 20 menit?", NamaAplikasi, MessageBoxButtons.YesNo, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then 'Tampilkan Lagi
            ReminderHutang = True
            ShowReminder = False
            TglUpdateReminder = TanggalSystem
        Else
    ...
    Private Sub XtraTabControl1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub GC1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub GC1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GC1.Click
