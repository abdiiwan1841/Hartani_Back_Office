...
Module mdlODBC
    ...
    Public Sub CreateSystemDSN(ByVal DSNName As String, ByVal ServerName As String, ByVal UserID As String, ByVal Password As String, ByVal DatabaseName As String)
