...
Public Class frBayarHutangOld
    ...
    Sub Simpan()
        ...
        If IsNew Then
            ...
            IDKas & "," & IDAkunHutang & "," & IDAkunDiskon & "," & IDAkunDenda & ",0)")
        Else
    ...
    Sub RefreshItem()
        ...
        If IDAlamat <> -1 Then
            If IsNew Then
                ...
                "Select " & IsJual & " as IsJual, MBeli.NoID," & IDUserAktif & " As IDUser,Tanggal,JatuhTempo,Kode,KodeReff," & _
    ...
    Private Sub frBayarHutang_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        GridView1.SaveLayoutToXml(Application.StartupPath & "\System\Layouts\EntriBayarHutangNF.xml")
    End Sub
    ...
    Private Sub frBayarHutang_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        SetTombol()
        TampilData()
        If Dir(Application.StartupPath & "\System\Layouts\EntriBayarHutangNF.xml") <> "" Then
            GridView1.RestoreLayoutFromXml(Application.StartupPath & "\System\Layouts\EntriBayarHutangNF.xml")
        End If
    End Sub
