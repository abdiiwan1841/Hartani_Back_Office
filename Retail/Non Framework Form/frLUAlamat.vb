...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frLUAlamat))
...
#End Region
    ...
    Public Sub TampilData()
        ...
        strsql = "Select * " & _
        "FROM MAlamat  WHERE MAlamat.IsActive=1 "
        If IsPegawai Then
            strsql = strsql & " and IsPegawai=1"
        End If
        If IsCustomer Then
            strsql = strsql & " and IsCustomer=1"
        End If
        If IsSupplier Then
            strsql = strsql & " and IsSupplier=1"
        End If
        Try
    ...
    Private Sub SimpleButton5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If XtraMessageBox.Show(Me, "Yakin Mau Hapus data ini?", ".:: HAPUS DATA ALAMAT ::.", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            EksekusiSQL("Update MAlamat set IsActive=0 where NoID=" & NoID)
            TampilData()
        End If
    End Sub
