...
Public Class frmImportDataBarang
    Public FormName As String = "ImportDataBarang"
    ...
    Private Sub SimpleButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton2.Click
        If MsgBox("Yakin Mau Proses Import Data Barang" & "Sebelum Proses Cek dulu Kode dan data lainnya sudah benar!", MsgBoxStyle.Question + MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            ProsesImport()
        End If
    End Sub
    Sub ProsesImport()
        ...
        For i = 0 To ds.Tables(0).Rows.Count - 1
            ...
            If IDKategori <= 0 Then
                ...
                EksekusiSQL("Insert Into MKategori(NoID,IDParent,Kode,Nama,IsActive) values(" & _
                            IDKategori & ",-1,'" & Format(IDKategori, "000") & "','" & FixApostropi(Kategori.Trim) & "',1)")
            ...
            If NoIDBarangD <= 0 Then 'tidak ada
                ...
                If NoIDBarang <= 0 Then 'Barang belum ada
                    ...
                    EksekusiSQL("Insert into MBarang(NoID,IDkategori,Kode,Nama,IDSatuan,IDSatuanHarga,Konversi,HargaBeli,HargaBeliPcs,HargaBeliPcsBruto,Isactive,IsPoin,IdTypePajak,CtnPcs,Barcode,HargaJual,HargaJualNetto) values(" & _
                               NoIDBarang & "," & IDKategori & ",'" & FixApostropi(Kode.Trim) & "','" & FixApostropi(Nama.Trim) & "',1,1,1," & FixKoma(HargaBeli) & "," & FixKoma(HargaBeli) & "," & FixKoma(HargaBeli) & ",1,1,0,1,'" & FixApostropi(Kode.Trim & IIf(Ukuran.Trim = "", "", "-") & Ukuran.Trim) & "'," & FixKoma(HargaJual) & "," & FixKoma(HargaJual) & ")")
            ...
            Else 'Barang Detil ada dan Barang Ada
                ...
                Else
                    EksekusiSQL("Update MBarang Set IDKategori=" & IDKategori & ",IsActive=1,IsPoin=1, Nama='" & FixApostropi(Nama.Trim) & "',HargaJual=" & FixKoma(HargaJual) & ",HargaJualNetto=" & FixKoma(HargaJual) & " where NoID=" & NoIDBarang)
                End If
