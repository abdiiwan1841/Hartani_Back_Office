...
Public Class frmCetakBarcode
    ...
    Private Sub RefreshLookUp()
        ...
        Try
            ...
            SQL = "SELECT MTipeCetakBarcode.NoID, MTipeCetakBarcode.Kode, MTipeCetakBarcode.NamaFile FROM MTipeCetakBarcode "
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Try
            strsql = "select MBarangD.NoID from MBarangD where LastUpdated>='" & Strings.Format(tglDari.DateTime, "yyyy/MM/dd") & "' and LastUpdated<'" & Strings.Format(TglSampai.DateTime.AddDays(1), "yyyy/MM/dd") & "' and MbarangD.IsActive=1 order by MBarangD.Barcode "
